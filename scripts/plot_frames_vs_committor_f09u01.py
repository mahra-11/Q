"""
Histogram: number of frames vs. their assigned committor value, using the
folded=0.9 / unfolded=0.1 threshold results.
"""
import numpy as np
import pandas as pd
import matplotlib
...
CURVE_CSV  = "/scratch/mma9420/committor_check/Q/committor_1d_visits_sem_f09u01.csv"
OUT_PNG    = "/scratch/mma9420/committor_check/Q/frames_vs_committor_f09u01.png"
N_BINS     = 40   # must match the N_BINS used to build committor_1d_visits_sem_f09u01.csv
...
ax.set_title("Frame count by committor value (visit-based, folded=0.9/unfolded=0.1)")
plt.tight_layout()
