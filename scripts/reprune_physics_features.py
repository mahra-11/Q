...
# Only drop a feature if BOTH passes agree it's redundant -- see
# build_physics_features.py for why (contact_res1_res8 / sc_dist_res1_res8
# were both dropped on the all-frames view alone, despite neither being
# redundant within the transition region specifically).
